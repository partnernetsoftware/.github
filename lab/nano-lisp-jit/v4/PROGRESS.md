...
| Codegen | Lisp IR 整表 → blob | onion.layer + onion.tdd + verified | **~58%** |
| 编排 | Lisp `(squad-*)` | onion-tdd-milestone wave182 | **~53%** |
| 构建 | plan 内 build 图 | wave182 add177 | **~68%** |
| 自举 | `.com` 生成下一代 | 未开卷 | **~0%** |

**整体终局**：约 **15–22%**（wave211–224 CLI 批，见 EVAL；gate 后更新 tests.pass）。
