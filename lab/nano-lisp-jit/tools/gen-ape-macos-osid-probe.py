#!/usr/bin/env python3
"""Wave103: APE v2 4-row probe — Linux 2 slice + macOS os_id=2 placeholder rows (size=0)."""
...
def main() -> int:
    ...
    print(f"ape.macos.probe.output={out_p}")
    print(f"ape.macos.probe.bytes={len(probe)}")
    print(f"ape.macos.probe.slice_count=4")
    print(f"ape.macos.probe.macos_rows=2")
    return 0
