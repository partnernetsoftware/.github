...
if [ -x "$ROOT/lab/nano-lisp-jit/.build/nano-lisp/nano-lisp-host.com" ] \
  || [ -x "$ROOT/lab/nano-lisp-jit/.build/nano-lisp/nano-lisp.com" ] \
  || [ -x "$ROOT/lab/nano-lisp-jit/.build/nano-jit/nano-jit.com" ]; then
  if [ -x "$(dirname "$0")/v45-wave62-nano-lisp-com-host-only-converge.sh" ]; then
    bash "$(dirname "$0")/v45-wave62-nano-lisp-com-host-only-converge.sh" || true
...
COM="$ROOT/lab/nano-lisp-jit/.build/nano-lisp/nano-lisp-host.com"
if [ ! -x "$COM" ]; then
