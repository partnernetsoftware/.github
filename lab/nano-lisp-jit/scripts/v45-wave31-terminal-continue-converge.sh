...
if [ -x "$NEXT_FULL" ]; then
  pids=()
  for spec in \
    "i64:lab/nano-lisp-jit/lisp/bootstrap/bootstrap-v45-boundary-i64.lisp" \
    "ptr:lab/nano-lisp-jit/lisp/bootstrap/bootstrap-v45-boundary-ptr.lisp" \
    "func:lab/nano-lisp-jit/lisp/bootstrap/bootstrap-v45-boundary-func.lisp" \
    "negative:lab/nano-lisp-jit/lisp/bootstrap/bootstrap-v45-boundary-negative.lisp"; do
    name=${spec%%:*}
    plan=${spec#*:}
