...
5. **Shell ladder product closure** — C no-arg **release** embed (7b source wired); flip dual-smoke C expectation after promote (see [`SHELL-REFLECTION.md`](SHELL-REFLECTION.md))
...
- [x] shell-dual partial in `nanolisp-dual-gate.sh` — nested c-gate (shell-noarg) + rs-gate (shell-dual, fgets, shell-ci)
