...
| 脚本 | 用途 |
|------|------|
| **`v45-wave28-factory-physical-continue-converge.sh`** | **默认**（wave27 + selfhost-next 全量矩阵） |
| `v45-wave27-codegen-coupled-converge.sh` | codegen 扩展活图 7/7 |
