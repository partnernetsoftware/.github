; Wave58 W4: selfhost × host-sh-retire 矩阵.
; Prefix v45-shrm- · no build-slice lispjit.c · no .sh · no .py steps.
(bootstrap
  ...
  (build-slice-lisp "lab/nano-lisp-jit/lisp/core/nano-jit-slice-min.lisp"
                    "lab/nano-lisp-jit/.build/v45-shrm-min-x86.elf"
                    "x86_64")
  (run-expect-exit "lab/nano-lisp-jit/.build/v45-shrm-min-x86.elf" 42)
  (compile "lab/nano-lisp-jit/lisp/modules/12-parse.lisp"
           "lab/nano-lisp-jit/.build/v45-shrm-mod12.lbin")
  (run "lab/nano-lisp-jit/.build/v45-shrm-mod12.lbin")
  (results-min "lab/nano-lisp-jit/.build/v45-entry.evidence" "v45.selfhost.lispjit_c_delete_matrix" "1")
