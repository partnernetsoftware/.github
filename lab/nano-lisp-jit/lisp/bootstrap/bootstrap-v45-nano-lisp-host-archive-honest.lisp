; Wave63 W2: nano-lisp-host.com 种子退仓 — 产品 COM = nano-lisp.com 原生 bootstrap.
(bootstrap
  ...
  (results-min "lab/nano-lisp-jit/.build/v45-entry.evidence" "v45.honest.nano_lisp_host_retired" "1")
  (results-min "lab/nano-lisp-jit/.build/v45-entry.evidence" "v45.physical.zero_cpysh" "1")
  (file-hash "lab/nano-lisp-jit/v4.5/DIFFUSE-WAVE63.md"))
