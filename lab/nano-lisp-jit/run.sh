...
TYPE_BAD_STORE_RODATA_EXE="$BUILD_DIR/type_error_store_rodata_bad"
TYPE_BAD_STORE_RODATA_OBJ="$BUILD_DIR/type_error_store_rodata_bad.o"
...
log "type.bad.store.rodata.source.path=$TYPE_BAD_STORE_RODATA_SRC"
log "type.bad.store.rodata.source.bytes=$(bytes_of "$TYPE_BAD_STORE_RODATA_SRC")"
...
if [ "$(uname -m)" = "x86_64" ] || [ "$(uname -m)" = "amd64" ]; then
  ...
  run_case "reject-store-rodata-type-error-elf64-code" "$RUNNER" compile-expect-exit 2 compile-elf64-code "$TYPE_BAD_STORE_RODATA_SRC" "$TYPE_BAD_STORE_RODATA_EXE"
  run_case "reject-store-rodata-type-error-aot-code" "$RUNNER" compile-expect-exit 2 aot-elf64-code "$TYPE_BAD_STORE_RODATA_BLOB" "$TYPE_BAD_STORE_RODATA_EXE"
  run_case "reject-store-rodata-type-error-aot-obj" "$RUNNER" compile-expect-exit 2 aot-elf64-obj-code "$TYPE_BAD_STORE_RODATA_BLOB" "$TYPE_BAD_STORE_RODATA_OBJ" "nano_type_bad_store_rodata"
