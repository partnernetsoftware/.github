...
(bootstrap
  ...
  (compile "lab/nano-lisp-jit/samples/mut-ptr-load-only.lisp" "lab/nano-lisp-jit/.build/bootstrap-aot-mut-ptr-load-only.lbin")
  (compile "lab/nano-lisp-jit/samples/type-error-store-rodata-bad.lisp" "lab/nano-lisp-jit/.build/bootstrap-aot-type-bad-store-rodata.lbin")
  ...
  (aot-elf64-code "lab/nano-lisp-jit/.build/bootstrap-aot-mut-ptr-load-only.lbin" "lab/nano-lisp-jit/.build/bootstrap-aot-mut-ptr-load-only-code.elf")
  (inspect-elf64-exe "lab/nano-lisp-jit/.build/bootstrap-aot-mut-ptr-load-only-code.elf")
  (run-expect-exit "lab/nano-lisp-jit/.build/bootstrap-aot-mut-ptr-load-only-code.elf" 1)
  ...
  (aot-elf64-obj-code "lab/nano-lisp-jit/.build/bootstrap-aot-mut-ptr-load-only.lbin" "lab/nano-lisp-jit/.build/bootstrap-aot-mut-ptr-load-only.o" "nano_bootstrap_mut_ptr_load_only")
  (inspect-elf64-obj "lab/nano-lisp-jit/.build/bootstrap-aot-mut-ptr-load-only.o")
  ...
  (link-elf64-exe "lab/nano-lisp-jit/.build/bootstrap-aot-const-ptr-mixed-ro-rw-linked" "nano_bootstrap_const_ptr_load_only" "lab/nano-lisp-jit/.build/bootstrap-aot-const-ptr-load-only.o" "lab/nano-lisp-jit/.build/bootstrap-aot-const-ptr-load-u8-code.o")
  (inspect-elf64-exe "lab/nano-lisp-jit/.build/bootstrap-aot-const-ptr-mixed-ro-rw-linked")
  (run-expect-exit "lab/nano-lisp-jit/.build/bootstrap-aot-const-ptr-mixed-ro-rw-linked" 1)
  ...
  (compile-elf64-code "lab/nano-lisp-jit/samples/mut-ptr-load-only.lisp" "lab/nano-lisp-jit/.build/bootstrap-aot-mut-ptr-load-only.elf")
  (inspect-elf64-exe "lab/nano-lisp-jit/.build/bootstrap-aot-mut-ptr-load-only.elf")
  (run-expect-exit "lab/nano-lisp-jit/.build/bootstrap-aot-mut-ptr-load-only.elf" 1)
  ...
  (compile-expect-exit 2 compile-elf64-code "lab/nano-lisp-jit/samples/type-error-store-rodata-bad.lisp" "lab/nano-lisp-jit/.build/bootstrap-aot-type-bad-store-rodata.elf")
  (compile-expect-exit 2 aot-elf64-code "lab/nano-lisp-jit/.build/bootstrap-aot-type-bad-store-rodata.lbin" "lab/nano-lisp-jit/.build/bootstrap-aot-type-bad-store-rodata-from-blob.elf")
  (compile-expect-exit 2 aot-elf64-obj-code "lab/nano-lisp-jit/.build/bootstrap-aot-type-bad-store-rodata.lbin" "lab/nano-lisp-jit/.build/bootstrap-aot-type-bad-store-rodata.o" "nano_bootstrap_type_bad_store_rodata")
