...
(bootstrap
  ...
  (compile "lab/nano-lisp-jit/samples/lispjit-modules/01-runtime-extra.lisp"
           "lab/nano-lisp-jit/.build/v45-sh-full-mod01.lbin")
  (run "lab/nano-lisp-jit/.build/v45-sh-full-mod01.lbin")
  (compile "lab/nano-lisp-jit/samples/lispjit-modules/02-compile.lisp"
           "lab/nano-lisp-jit/.build/v45-sh-full-mod02.lbin")
  (run "lab/nano-lisp-jit/.build/v45-sh-full-mod02.lbin")
  (compile "lab/nano-lisp-jit/samples/lispjit-modules/03-bootstrap-stub.lisp"
  ...
  (file-hash "lab/nano-lisp-jit/samples/lispjit-modules/00-runtime-core.lisp")
