...
(bootstrap
  ...
  (compile "lab/nano-lisp-jit/samples/arithmetic.lisp" "lab/nano-lisp-jit/.build/nano-jit/selfhost/gen1-arithmetic.lbin")
  (run "lab/nano-lisp-jit/.build/nano-jit/selfhost/gen1-arithmetic.lbin")
  (compile "lab/nano-lisp-jit/samples/func-call-vm-smoke.lisp" "lab/nano-lisp-jit/.build/nano-jit/selfhost/gen1-func-call.lbin")
  (run "lab/nano-lisp-jit/.build/nano-jit/selfhost/gen1-func-call.lbin")
  (compile "lab/nano-lisp-jit/samples/func-param-vm-i64.lisp" "lab/nano-lisp-jit/.build/nano-jit/selfhost/gen1-func-param-vm-i64.lbin")
