...
run_case "nano-jit-aot-cross-object-const-ptr-callee" "$BUILD_DIR/nano-jit.com" compile-elf64-obj-code "$CONST_PTR_SRC" "$CONST_PTR_CALLEE_OBJ" nano_const_ptr_callee
