...
#   rs-track: shell-ci, shell-repl-vm, shell-dual, shell-fgets (via nano-jit-rs-gate.sh)
set -euo pipefail
...
echo "nanolisp.dual-gate.shell=rs-track begin smokes=shell-ci,shell-repl-vm,shell-dual,shell-fgets"
