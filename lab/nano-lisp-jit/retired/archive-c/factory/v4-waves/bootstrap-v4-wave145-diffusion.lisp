; wave145 track-A: codegen-gates-v5.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-140.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice145-add140.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice145-add140.elf"))
