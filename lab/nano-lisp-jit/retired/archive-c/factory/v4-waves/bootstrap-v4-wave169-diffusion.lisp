; wave169 track-A: onion-plan-a.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-164.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice169-add164.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice169-add164.elf"))
