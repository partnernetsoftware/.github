; wave203 track-A: fast-irtable-203.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-198.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice203-add198.elf"
                    "aarch64")
