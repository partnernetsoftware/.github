; wave120 track-A: emit-terminal-chain.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-115.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice120-add115.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice120-add115.elf"))
