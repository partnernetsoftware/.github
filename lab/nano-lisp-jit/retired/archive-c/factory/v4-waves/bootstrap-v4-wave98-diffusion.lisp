; wave98 track-A: evidence-matrix-recap.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-93.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice98-add93.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice98-add93.elf"))
