; wave221 track-A: cli-lisponly-221.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-216.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice221-add216.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice221-add216.elf"))
