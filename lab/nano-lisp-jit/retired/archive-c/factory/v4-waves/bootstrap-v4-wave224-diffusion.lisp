; wave224 track-A: cli-runner-224.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-219.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice224-add219.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice224-add219.elf"))
