; wave209 track-A: fast-codegen-209.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-204.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice209-add204.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice209-add204.elf"))
