; wave57 track-A: four-track-recap.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-52.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice57-add52.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice57-add52.elf"))
