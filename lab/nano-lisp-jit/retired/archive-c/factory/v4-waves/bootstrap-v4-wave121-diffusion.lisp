; wave121 track-A: runner-codegen-close.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-116.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice121-add116.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice121-add116.elf"))
