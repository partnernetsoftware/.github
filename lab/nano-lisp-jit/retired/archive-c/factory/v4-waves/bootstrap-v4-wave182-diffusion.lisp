; wave182 track-A: onion-tdd-milestone.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-177.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice182-add177.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice182-add177.elf"))
