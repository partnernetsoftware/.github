; wave218 track-A: cli-plan-218.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-213.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice218-add213.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice218-add213.elf"))
