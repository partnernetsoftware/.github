; wave105 track-A: emit-lowering-chain.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-100.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice105-add100.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice105-add100.elf"))
