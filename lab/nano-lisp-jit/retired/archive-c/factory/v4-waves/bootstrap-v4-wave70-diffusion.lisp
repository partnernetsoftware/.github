; wave70 track-A: host-reduce-chain.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-65.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice70-add65.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice70-add65.elf"))
