; wave179 track-A: onion-lisp-b.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-174.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice179-add174.elf"
                    "aarch64")
