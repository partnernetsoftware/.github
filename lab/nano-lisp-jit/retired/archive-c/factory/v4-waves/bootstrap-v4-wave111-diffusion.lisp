; wave111 track-A: turbo-skill-evidence.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-106.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice111-add106.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice111-add106.elf"))
