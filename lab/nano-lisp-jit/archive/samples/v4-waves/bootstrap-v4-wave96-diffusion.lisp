; wave96 track-A: build-graph-recap.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/samples/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/samples/nano-jit-slice-add-91.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice96-add91.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice96-add91.elf"))
