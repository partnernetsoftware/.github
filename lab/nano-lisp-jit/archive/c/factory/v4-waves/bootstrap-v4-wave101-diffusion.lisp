; wave101 track-A: post-v4-anchor.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-96.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice101-add96.elf"
                    "aarch64")
