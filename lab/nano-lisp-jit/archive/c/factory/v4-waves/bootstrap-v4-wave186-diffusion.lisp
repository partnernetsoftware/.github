; wave186 track-A: fast-plan-186.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-181.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice186-add181.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice186-add181.elf"))
