; wave192 track-A: fast-runner-192.
(bootstrap
  (ir-table-lisp "lab/nano-lisp-jit/lisp/core/v4-ir-table-v1.lisp")
  (build-slice-lisp "lab/nano-lisp-jit/archive/c/factory/misc/nano-jit-slice-add-187.lisp"
                    "lab/nano-lisp-jit/.build/bootstrap-v4-slice192-add187.elf"
                    "aarch64")
  ...
  (file-hash "lab/nano-lisp-jit/.build/bootstrap-v4-slice192-add187.elf"))
